...
namespace MatheusProductions.AutomacaoN9010A
{
    ...
    {
        public void Largura_6dB(string valFreq, string ip, string nomePrint, string largura_Banda)
        {
            Keysight radical;
            ResourceManager rm;
            ...
            try 
            {
                ...
                radical.ConfiguraInstr(instr, valFreq, "Dbm", "30", "20", Span.ToString(), "100", "300", "ON", "MAXH", "POS", "OBW", "99", "-6");
        ...
        public void Largura_26dB(string valFreq, string ip, string nomePrint, string largura_Banda)
        {
            Keysight radical;
            ResourceManager rm;
            FormattedIO488 instr;
            ...
            try
            {
                ...
                // Seta as configurções basicas
                double Span = int.Parse(largura_Banda) * 1.5;
                radical.ConfiguraInstr(instr, valFreq, "Dbm", "30", "20", Span.ToString(), "100", "300", "ON", "MAXH", "POS", "OBW", "99", "-26");
        ...
        public void Pico_da_densidade_de_potência(string valFreq, string ip, string nomePrint, string largura_Banda)
        {
            Keysight radical;
            ResourceManager rm;
            FormattedIO488 instr;
            ...
            try // Try o bloco para capturar qualquer RsInstrumentException()
            {
                ...
                // Seta as configurções basicas
                double Span = int.Parse(largura_Banda) * 1.5;
                radical.ConfiguraInstr(instr, valFreq, "Dbm", "30", "20", Span.ToString(), "10", "30", "ON", "MAXH", "POS", "SAN");                
        ...
        public void Valor_médio_da_densidade_espectral_de_potência(string valFreq, string ip, string nomePrint, string largura_Banda)
        {
            Keysight radical;
            ResourceManager rm;
            FormattedIO488 instr;
            ...
            try
            {
                ...
                // Seta as configurções basicas
                double Span = int.Parse(largura_Banda) * 1.5;
                radical.ConfiguraInstr(instr, valFreq, "Dbm", "30", "20", Span.ToString(), "3", "10", "ON", "AVER", "RMS", "SAN");
                instr.IO.Timeout = 2000;
                instr.WriteString("INIT");
                string nomeArquivo = "Valores do ensaio.csv";
                //Salvando os Valores do Marker
        ...
        public void Potência_de_pico_máxima(string valFreq, string ip, string nomePrint, string largura_Banda)
        {
            Keysight radical;
            ResourceManager rm;
            FormattedIO488 instr;
            ...
            try
            {
                ...
                radical.ConfiguraInstr(instr, valFreq, "Dbm", "30", "20", Span.ToString(), "1000", "3000", "ON", "MAXH", "POS", "CHP", largura_Banda);
                instr.IO.Timeout = 2000;
                instr.WriteString("INIT");
                string nomeArquivo = "Valores do ensaio.csv";
                //Pega os Valores
        ...
        public void Valor_médio_da_potência_máxima_de_saída(string valFreq, string ip, string nomePrint, string largura_Banda)
        {
            Keysight radical;
            ResourceManager rm;
            FormattedIO488 instr;
            ...
            try
            {
                ...
                double Span = int.Parse(largura_Banda) * 1.5;
                // OBS: Será usado para ensaio o valor minimo permitido pela norma de acordo com o Item 9.1.8 (Opção 3) da 6506
                radical.ConfiguraInstr(instr, valFreq, "Dbm", "30", "20", Span.ToString(), "1000", "3000", "ON", "MAXH", "RMS", "CHP", largura_Banda);
                instr.IO.Timeout = 2000;
                instr.WriteString("INIT");
                string nomeArquivo = "Valores do ensaio.csv";
                //Pega os Valores
